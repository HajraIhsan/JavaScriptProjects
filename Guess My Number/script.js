...
document.querySelector('.check').addEventListener('click', function () {
  ...
  if (!guess) {
    ...
    if (score > 1) {
      ...
      document.querySelector('.label-score').style.color = '#ff0000';
      document.querySelector('.label-highscore').style.color = '#ff0000';
...
//   document.querySelector('number').textContent = '?';
//   document.querySelector('.guess').value = '';
//   document.querySelector('body').style.n = backgroundColor = '#222';
//   document.querySelector('.number').style.width = '15rem;';
// });
